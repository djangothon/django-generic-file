(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<br/><span><b>Drag &amp; Drop Files</b></span><br/>",
            uploadStr: '<i class="fa fa-upload"></i>',
            abortStr: "Abort",
            cancelStr: "Cancel",
            doneStr: "Done",
            deletelStr: '<i class="fa fa-trash"></i>',
            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $("<div class='list-group collection xajax-file-upload-container'></div>").insertAfter($(obj));
        ...
        this.createProgress = function (file) {
            var pd = new createProgressDiv(this, s);
            //pd.progressDiv.show();
            //pd.progressbar.width('100%');

            var fileNameStr = "";
            if(s.showFileCounter) fileNameStr = obj.fileCounter + s.fileCounterStyle + file.name;
            ...
            if(s.showDownload) {
                ...
                pd.download.click(function () {
                    ...
                    if(s.downloadCallback) s.downloadCallback.call(this, file, pd);
                });
            }
            ...
            if (s.showDelete) {
                ...
                pd.del.click(function () {
                    if (confirm('Are you sure you want to delete this file?')){
                        ...
                        if(s.deleteCallback) s.deleteCallback.call(this, file, pd);
                        obj.selectedFiles -= 1;
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<div class='list-group-item collection-item sbar xajax-file-upload-statusbar'></div>").width(s.statusBarWidth);
            this.preview = $("<img class='ajax-file-upload-preview' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            this.filename = $("<div class='ajax-file-upload-filename'></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='ajax-file-upload-bar'></div>").appendTo(this.progressDiv);

            this.abort = $("<span class='btn btn-xs btn-danger'>" + s.abortStr + "</span>").appendTo(this.statusbar).hide();
            this.cancel = $("<span class='btn btn-xs btn-default'>" + s.cancelStr + "</span>").appendTo(this.statusbar).hide();
            this.done = $("<span class='btn btn-xs btn-default'>" + s.doneStr + "</span>").appendTo(this.statusbar).hide();
            this.download = $("<span class='btn btn-xs btn-default'>" + s.downloadStr + "</span>").appendTo(this.statusbar).hide();
            this.del = $("<span class='btn btn-xs btn-danger'>" + s.deletelStr + "</span>").appendTo(this.statusbar).hide();
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj, file) {
            ...
            var options = {
                ...
                success: function (data, message, xhr) {
                	pd.cancel.remove();
                	pd.progressDiv.remove();
                	progressQ.pop();

                	pd.filename.text(data.name);
                	//For custom errors.
                    ...
                    if(s.showDownload) {
                        ...
                        pd.download.click(function () {
                            ...
                            if(s.downloadCallback) s.downloadCallback.call(this, data, pd);
                        });
                    }
                    form.remove();
                },
